...
@pytest.fixture
def kredyt1():
    return procenty.kredyt.Kredyt(Decimal(4000), 30, Decimal(0.1), Decimal(0.1), dt.datetime(2021, 1, 1), 'rowne')

@pytest.fixture
def kredyt2():
    return procenty.kredyt.Kredyt(Decimal(40000), 320, Decimal(0.1), Decimal(0.1), dt.datetime(2021, 1, 1), 'rowne')
