...
def main():
    ...
    if request.method == "POST":
        ...
        form_data = {
            "kapital1": request.form["kapital1"],
        ...
        try:
            ...
            if (
                data_zamrozenia > max_day_wibor3m
                if rodzajWiboru == "3M"
                else data_zamrozenia > max_day_wibor6m
            ):
                ...
                return render_template(
                    ...
                    form_data=form_data,
                    error=error,
                    max_day_wibor3m=max_day_wibor3m.strftime("%d-%m-%Y"),
        ...
        dane_kredytu = utils.generate_model.generateFromWiborFile(
            kapital1,
            okresy,
            data_start1,
            marza,
        ...
        dane_kredytu_alt = utils.generate_model.generateFromWiborFile(
            kapital1,
            okresy,
            data_start1,
            marza,
